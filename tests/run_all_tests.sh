...
run_test "test_parser_stress" "src/network/ClientSocket.cpp src/http/HttpRequest.cpp src/http/RequestParser.cpp src/network/EventLoop.cpp" "tests/test_parser_stress.cpp"
run_test "test_integration" "src/network/ClientSocket.cpp src/http/HttpRequest.cpp src/http/RequestParser.cpp src/network/EventLoop.cpp" "tests/test_integration.cpp"
