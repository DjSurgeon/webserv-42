...
run_test "test_config_parser" "src/config/Context.cpp src/config/LocationConfig.cpp src/config/ServerConfig.cpp src/config/ConfigParser.cpp" "tests/test_config_parser.cpp"
