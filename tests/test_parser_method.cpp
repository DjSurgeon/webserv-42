...
void test_skip_leading_whitespace_and_newlines() {
  std::cout << "[Test] Skipping leading whitespaces, carriage returns, and "
               "newlines..."
            << std::endl;
  RequestParser parser;
...
void test_invalid_character_in_method() {
  std::cout << "[Test] Error handling for invalid characters in method..."
            << std::endl;
  RequestParser parser;
...
void test_invalid_start_character() {
  std::cout << "[Test] Error handling for invalid starting characters..."
            << std::endl;
  RequestParser parser;
