...
void test_invalid_http_version() {
  std::cout
      << "[Test] Error handling for unsupported HTTP version (HTTP/1.0)..."
      << std::endl;
  RequestParser parser;
...
void test_version_syntax_mismatch() {
  std::cout
      << "[Test] Error handling for version syntax mismatch (HTTP/1.1a)..."
      << std::endl;
  RequestParser parser;
...
void test_missing_carriage_return() {
  std::cout << "[Test] Error handling for missing carriage return (\\r)..."
            << std::endl;
  RequestParser parser;
...
void test_invalid_char_after_carriage_return() {
  std::cout << "[Test] Error handling for invalid character after \\r..."
            << std::endl;
  RequestParser parser;
