...
void test_get_request_no_body() {
  std::cout << "[Test] GET request with no Content-Length header..."
            << std::endl;
...
void test_post_request_zero_content_length() {
  ...
  print_result("test_post_request_zero_content_length",
               state == STATE_COMPLETE);
}

void test_post_request_with_body() {
  std::cout << "[Test] POST request with Content-Length and body..."
            << std::endl;
  RequestParser parser;
...
void test_post_request_invalid_content_length() {
  std::cout << "[Test] POST request with non-numeric Content-Length..."
            << std::endl;
  RequestParser parser;
  ...
  print_result("test_post_request_invalid_content_length",
               state == STATE_ERROR);
}
